...
void main() {
  group('DASS-21 Depression Interpretation', () {
    ...
    test('UT02: score 12 returns Mild', () {
      expect(MindEaseHelpers.interpretDepression(12), 'Mild');
    });
    test('UT03: score 18 returns Moderate', () {
      expect(MindEaseHelpers.interpretDepression(18), 'Moderate');
    });
  ...
  group('Mood Chart Date Range Generation', () {
    test('UT25: 7-day range with 3 logged dates returns 7 dates with correct gaps', () {
